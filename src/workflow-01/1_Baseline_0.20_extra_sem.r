...
envg$EXPENV <- list()
envg$EXPENV$exp_dir <- "~/buckets/b1/exp/Under_0.20"
envg$EXPENV$wf_dir <- "~/buckets/b1/flow/Under_0.20"
envg$EXPENV$wf_dir_local <- "~/flow/"
envg$EXPENV$repo_dir <- "~/labo2024v1/"
envg$EXPENV$datasets_dir <- "~/buckets/b1/datasets/"
envg$EXPENV$arch_sem <- "mis_semillas_exp.txt"
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  ZZ_final_guantesblancos( "ZZ0001_extrasem", c("HT0001","TS0001") )
...
corrida_guantesblancos_202109( "gb01_extrasem" )
