...
envg$EXPENV <- list()
envg$EXPENV$exp_dir <- "~/buckets/b1/exp/1Semillerio"
envg$EXPENV$wf_dir <- "~/buckets/b1/flow/1Semillerio"
...
TS_strategy_baseline_202109 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$train$training <- c(202105, 202104, 202103, 202002, 202001, 201912, 
...
ZZ_final_baseline <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$kaggle$envios_desde <-  12250L
...
corrida_baseline_semillerio_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  ZZ_final_semillerio_baseline( "ZZ0001-sem-mas-env", c("HT0001-sem","TS0001-sem") )
